...
const ScrollTopButton = () => {
  ...
  return (
    <button type='button'
            onClick={scrollTop}
            className='absolute origin-center left-1/2 btn-scroll-top bg-themeOrange-100 hover:bg-themeOrange-300 transition-all ease-in-out duration-300 rounded-xl h-12 w-12 -top-6'>
...
const Footer = () => {
  ...
  return (
    <div className='bg-themeGrey-200 relative'>
      <ScrollTopButton />
      <div className="flex justify-center md:justify-between flex-col md:flex-row text-white p-12 max-w-7xl mx-auto">
        <div className='flex justify-center gap-4 mb-3 md:mb-0'>
          <button type='button'
                  onClick={() => setToggleDataProtection(!toggleDataProtection)}
                  className='hover:text-themeOrange-100 ease-in-out duration-300'>
            Datenschutz
          </button>
          <button type='button'
        ...
        <p className='text-center'>Copyright © 2023 by Philipp Schurig. All Rights Reserved.</p>
      </div>
      ...
      <Modal onClose={() => setToggleDataProtection(false)} isShow={toggleDataProtection}>
        ...
        <h3 className='section-sub-text mb-3'>Allgemeine Hinweise</h3>
        ...
        <h3 className='section-sub-text mb-3'>Datenerfassung auf dieser Website</h3>
        ...
        <h3 className='section-sub-text mb-3'>Analyse-Tools und Tools von Dritt&shy;anbietern</h3>
        ...
        <h3 className='section-sub-text mb-3'>Strato</h3>
        ...
        <h3 className='section-sub-text mb-3'>Datenschutz</h3>
        ...
        <h3 className='section-sub-text mb-3'>Hinweis zur verantwortlichen Stelle</h3>
        ...
        <h3 className='section-sub-text mb-3'>Speicherdauer</h3>
        ...
        <h3 className='section-sub-text mb-3'>Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
        ...
        <h3 className='section-sub-text mb-3'>Hinweis zur Datenweitergabe in die USA und sonstige Drittstaaten</h3>
        ...
        <h3 className='section-sub-text mb-3'>Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
        ...
        <h3 className='section-sub-text mb-3'>Widerspruchsrecht gegen die Datenerhebung in besonderen F&auml;llen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
        ...
        <h3 className='section-sub-text mb-3'>Beschwerde&shy;recht bei der zust&auml;ndigen Aufsichts&shy;beh&ouml;rde</h3>
        ...
        <h3 className='section-sub-text mb-3'>Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
        ...
        <h3 className='section-sub-text mb-3'>Auskunft, Berichtigung und L&ouml;schung</h3>
        ...
        <h3 className='section-sub-text mb-3'>Recht auf Einschr&auml;nkung der Verarbeitung</h3>
        ...
        <h3 className='section-sub-text mb-3'>SSL- bzw. TLS-Verschl&uuml;sselung</h3>
        ...
        <h3 className='section-sub-text mb-3'>Cookies</h3>
        ...
        <h3 className='section-sub-text mb-3'>Server-Log-Dateien</h3>
        ...
        <h3 className='section-sub-text mb-3'>Kontaktformular</h3>
        ...
        <h3 className='section-sub-text mb-3'>Anfrage per E-Mail oder Telefon</h3>
        ...
        <h3 className='section-sub-text mb-3'>Facebook</h3>
        ...
        <h3 className='section-sub-text mb-3'>Twitter</h3>
        ...
        <h3 className='section-sub-text mb-3'>Instagram</h3>
        ...
        <h3 className='section-sub-text mb-3'>Google Fonts (lokales Hosting)</h3>
        ...
        <h3 className='section-sub-text mb-3'>Font Awesome (lokales Hosting)</h3>
        ...
        <h3 className='section-sub-text mb-3'>Google reCAPTCHA</h3>
